...
// A missing or truncated ledger simply yields no expectation — the run then
// establishes the baseline instead of judging one.
func (r *report) readDurableLedger() map[string]int {
	out := map[string]int{}
