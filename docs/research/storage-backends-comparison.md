...
make the final choice. Companion to the earlier survey in
[`storage-backends.md`](./storage-backends.md), to
[ADR-0003 (persistence & storage)](../adr/0003-persistence-and-storage.md) and
